...
class Main {
    start() {
        ...
        const tableHeader = generater.generateTableHeader();
        generater.setTableData(tableHeader, periodicTableHtml.upper);
        const src = Source.getPeriodicTableData();
        const tableContainer = generater.generateTableContainer(src);
