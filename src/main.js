...
class Main { 
    ...
    start() {
        ...
        const table_container = this.make_table_container(table_data);
    ...
    add_click_action() {
        ...
        for (const td of el_arr) {
            td.addEventListener("click", event => {
                ...
                const pos_x = Number(target.dataset.x);
                const pos_y = Number(target.dataset.y);
                this.make_splash(pos_x, pos_y);
            }, false);
        };
    };
